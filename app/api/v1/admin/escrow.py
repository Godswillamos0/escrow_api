...
from schemas.escrow import EscrowResponse
router = APIRouter(
    prefix="/escrow",
    tags=["escrow"]
)
...
router.get("/get_escrow_by_id", status_code=status.HTTP_200_OK, response_model=EscrowResponse)(get_escrow_by_id)
...
router.post("/resolve_dispute", status_code=status.HTTP_200_OK)(resolve_dispute)
